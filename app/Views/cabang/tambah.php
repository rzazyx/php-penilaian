    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="my-3">Form Tambah Cabang</h2>
            </div>
            <!--error data-->
            ...
            <form action="/cabang/simpan" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="cabang" name="nama_cabang" value="<?= old('nama_cabang'); ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="pic" class="col-sm-2 col-form-label">Nama PIC</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="pic" name="nama_pic" value="<?= old('nama_pic'); ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="telp" class="col-sm-2 col-form-label">No. Telp</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="telp" name="no_telp" value=" <?= old('no_telp'); ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
