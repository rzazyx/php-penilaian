    ...
    <div class="container"> <!-- Mengubah ke kelas container-lg -->
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <?php endif ?>
                <!--error data-->
                <form action="/penilaian/updatemitra/<?= $penilaian['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                                <input type="number" class="form-control" id="personil1" name="personil1" value="<?= $penilaian['mitra1']; ?>">
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <?php if (!empty($penilaian['gambar_mitra1'])) : ?>
                                        <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                        <img src="/public/uploads/<?= $penilaian['gambar_mitra1']; ?>" class="img-thumbnail" alt="Gambar Personil 1" width="100">
                                    <?php else : ?>
                        ...
                        <div class="mb-3 row">
                            <label for="g_pmitra1" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                            <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                            <input type="number" class="form-control" id="personil11" name="personil11" value="<?= $penilaian['mitra2']; ?>">
                        </div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <?php if (!empty($penilaian['gambar_mitra2'])) : ?>
                                    <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                    <img src="/public/uploads/<?= $penilaian['gambar_mitra2']; ?>" class="img-thumbnail" alt="Gambar Personil 1" width="100">
                                <?php else : ?>
                                    <p>Gambar tidak tersedia</p>
                                <?php endif; ?>
                            </div>
                    ...
                    <!-- Sedikan opsi untuk mengunggah gambar baru -->
                    <div class="mb-3 row">
                        <label for="g_pmitra2" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                        <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                            <input type="number" class="form-control" id="personil21" name="personil21" value="<?= $penilaian['mitra3']; ?>">
                        </div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <?php if (!empty($penilaian['gambar_mitra3'])) : ?>
                                    <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                    <img src="/public/uploads/<?= $penilaian['gambar_mitra3']; ?>" class="img-thumbnail" alt="Gambar Personil 1" width="100">
                                <?php else : ?>
                                    <p>Gambar tidak tersedia</p>
                                <?php endif; ?>
                            </div>
                    ...
                    <!-- Sedikan opsi untuk mengunggah gambar baru -->
                    <div class="mb-3 row">
                        <label for="g_pmitra3" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                        <div class="col-sm-9">
