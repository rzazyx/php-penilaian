...
<head>
    ...
    <title>Edit Nilai Personil</title>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="my-3">Form Edit Nilai Personil</h2>
                </div>
                ...
                <?php endif ?>
                <form action="/penilaian/updatepersonil/<?= $penilaian['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                                <input type="number" class="form-control" id="personil1" name="personil1" value="<?= $penilaian['nilai_personil1']; ?>">
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <?php if (!empty($penilaian['gambar_personil1'])) : ?>
                                        <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                        <img src="/public/uploads/<?= $penilaian['gambar_personil1']; ?>" class="img-thumbnail" alt="Gambar Personil 1" width="100">
                                    <?php else : ?>
                        ...
                        <div class="mb-3 row">
                            <label for="g_personil1" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                            <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                            <input type="number" class="form-control" id="personil11" name="personil11" value="<?= $penilaian['nilai_personil2']; ?>">
                        </div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                        ...
                        <div class="mb-3 row">
                            <label for="g_personil2" class="col-sm-3 col-form-label">Gambar Personil 2</label>
                            <div class="col-sm-9">
                                <?php if (!empty($penilaian['gambar_personil2'])) : ?>
                                    <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                    <img src="/public/uploads/<?= $penilaian['gambar_personil2']; ?>" class="img-thumbnail" alt="Gambar Personil 2" width="100">
                                <?php else : ?>
                        ...
                        <!-- Sedikan opsi untuk mengunggah gambar baru -->
                        <div class="mb-3 row">
                            <label for="g_personil2" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                            <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                            <input type="number" class="form-control" id="personil21" name="personil21" value="<?= $penilaian['nilai_personil3']; ?>">
                        </div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                        ...
                        <div class="mb-3 row">
                            <label for="g_personil3" class="col-sm-3 col-form-label">Gambar Personil 3</label>
                            <div class="col-sm-9">
                                <!-- Tambahkan logika PHP untuk menampilkan gambar jika tersedia -->
                                <?php if (!empty($penilaian['gambar_personil3'])) : ?>
                                    <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                    <img src="/public/uploads/<?= $penilaian['gambar_personil3']; ?>" class="img-thumbnail" alt="Gambar Personil 3" width="100">
                                <?php else : ?>
                                    <!-- Tampilkan pesan jika gambar tidak tersedia -->
                                    <p>Gambar tidak tersedia</p>
                                <?php endif; ?>
                        ...
                        <!-- Sedikan opsi untuk mengunggah gambar baru -->
                        <div class="mb-3 row">
                            <label for="g_personil3" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                            <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                            <input type="number" class="form-control" id="personil31" name="personil31" value="<?= $penilaian['nilai_personil4']; ?>">
                        </div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                        ...
                        <div class="mb-3 row">
                            <label for="g_personil4" class="col-sm-3 col-form-label">Gambar Personil 4</label>
                            <div class="col-sm-9">
                                <!-- Tambahkan logika PHP untuk menampilkan gambar jika tersedia -->
                                <?php if (!empty($penilaian['gambar_personil4'])) : ?>
                                    <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                    <img src="/public/uploads/<?= $penilaian['gambar_personil4']; ?>" class="img-thumbnail" alt="Gambar Personil 4" width="100">
                                <?php else : ?>
                                    <!-- Tampilkan pesan jika gambar tidak tersedia -->
                                    <p>Gambar tidak tersedia</p>
                                <?php endif; ?>
                        ...
                        <!-- Sedikan opsi untuk mengunggah gambar baru -->
                        <div class="mb-3 row">
                            <label for="g_personil4" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                            <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
                            <input type="number" class="form-control" id="personil41" name="personil41" value="<?= $penilaian['nilai_personil5']; ?>">
                        </div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                        ...
                        <div class="mb-3 row">
                            <label for="g_personil5" class="col-sm-3 col-form-label">Gambar Personil 5</label>
                            <div class="col-sm-9">
                                <!-- Tambahkan logika PHP untuk menampilkan gambar jika tersedia -->
                                <?php if (!empty($penilaian['gambar_personil5'])) : ?>
                                    <!-- Tampilkan gambar yang sudah diunggah sebelumnya -->
                                    <img src="/public/uploads/<?= $penilaian['gambar_personil5']; ?>" class="img-thumbnail" alt="Gambar Personil 5" width="100">
                                <?php else : ?>
                                    <!-- Tampilkan pesan jika gambar tidak tersedia -->
                                    <p>Gambar tidak tersedia</p>
                                <?php endif; ?>
                        ...
                        <!-- Sedikan opsi untuk mengunggah gambar baru -->
                        <div class="mb-3 row">
                            <label for="g_personil5" class="col-sm-3 col-form-label">Unggah Gambar Baru</label>
                            <div class="col-sm-9">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-3"></div>
                        <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 3 -->
                            <input type="number" class="form-control" id="totalDisplay" name="total" value="<?= $penilaian['total']; ?>" readonly>
                        </div>
                    </div>
