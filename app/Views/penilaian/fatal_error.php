    ...
    <div class="container"> <!-- Mengubah ke kelas container-lg -->
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <?php endif ?>
                <!--error data-->
                <form action="/penilaian/tambahfatal_error/<?= $id; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="personil" class="col-sm-3 col-form-label">Laporan keluhan dari pihak Direksi</label>
                            <div class="col-sm-3"> <!-- Mengubah lebar kolom menjadi 6 -->
